    ...
    function getOTK(brandid, form, adminAreaUrl) {
        return new Promise((resolve, reject) => {
            if (_.isUndefined(adminAreaUrl)) {
                reject(new LoginError(brandid, undefined, "undefined adminAreaUrl", undefined));
            }
            ...
            form.submit(adminAreaUrl, function (err, res) {
                ...
                if (successOTK) {
                    ...
                    reject(new LoginError(brandid, otkErrCode , otkErrMsg, httpCode));
                }
            });
        })
    }
    ...
    function loginToLiveEngage(brandid, otk, liveEngageUrl) {
        return new Promise((resolve, reject) => {
            if (_.isUndefined(liveEngageUrl)) {
                reject(new LoginError(brandid, undefined, "undefined liveEngageUrl", undefined));
            }
            ...
            request(options, function (error, response, body) {
                ...
                reject(new LoginError(brandid, errCode, message, httpCode));
            });
        });
    }
            ...
            return new Promise((resolve, reject) => {
                ...
                getOTK(brandid, form, adminAreaUrl).then(function(otk){
                    loginToLiveEngage(brandid, otk, liveEngageUrl).then(function(glob){
                        ...
                        reject(new LoginError(brandid, undefined, error.message));
                    });
                }).catch(function(error){
                    reject(new LoginError(brandid, undefined, error.message));
                });
